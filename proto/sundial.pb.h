...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_sundial_2eproto_metadata_getter(int index);
...
inline void SundialRequest::_internal_set_log_data(const std::string& value) {
  ...
  log_data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void SundialRequest::set_log_data(const char* value) {
  ...
  log_data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
...
inline void SundialRequest::set_log_data(const void* value,
  ...
  log_data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* SundialRequest::_internal_mutable_log_data() {
  ...
  return log_data_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
