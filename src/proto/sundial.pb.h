...
enum SundialRequest_RequestType : int {
  ...
  SundialRequest_RequestType_PAXOS_LOG = 20,
  SundialRequest_RequestType_PAXOS_REPLICATE = 21,
  SundialRequest_RequestType_NUM_REQ_TYPES = 22,
...
enum SundialRequest_LogType : int {
  SundialRequest_LogType_LOG_SYNC = 0,
  SundialRequest_LogType_LOG_ASYNC = 1,
  SundialRequest_LogType_LOG_IF_NE = 2,
  SundialRequest_LogType_LOG_IF_NE_DATA = 3,
  SundialRequest_LogType_LOG_SYNC_DATA = 4,
  SundialRequest_LogType_LOG_ASYNC_DATA = 5,
  SundialRequest_LogType_SundialRequest_LogType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  SundialRequest_LogType_SundialRequest_LogType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool SundialRequest_LogType_IsValid(int value);
constexpr SundialRequest_LogType SundialRequest_LogType_LogType_MIN = SundialRequest_LogType_LOG_SYNC;
constexpr SundialRequest_LogType SundialRequest_LogType_LogType_MAX = SundialRequest_LogType_LOG_ASYNC_DATA;
constexpr int SundialRequest_LogType_LogType_ARRAYSIZE = SundialRequest_LogType_LogType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* SundialRequest_LogType_descriptor();
template<typename T>
inline const std::string& SundialRequest_LogType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, SundialRequest_LogType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function SundialRequest_LogType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    SundialRequest_LogType_descriptor(), enum_t_value);
}
inline bool SundialRequest_LogType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, SundialRequest_LogType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<SundialRequest_LogType>(
    SundialRequest_LogType_descriptor(), name, value);
}
...
enum SundialResponse_RequestType : int {
  ...
  SundialResponse_RequestType_PAXOS_LOG_ACK = 14,
  SundialResponse_RequestType_PAXOS_REPLICATE_ACK = 15,
  SundialResponse_RequestType_NUM_REQ_TYPES = 16,
...
class SundialRequest final :
 ...
 public:
  ...
  static constexpr RequestType PAXOS_LOG =
    SundialRequest_RequestType_PAXOS_LOG;
  static constexpr RequestType PAXOS_REPLICATE =
    SundialRequest_RequestType_PAXOS_REPLICATE;
  ...
  typedef SundialRequest_LogType LogType;
  static constexpr LogType LOG_SYNC =
    SundialRequest_LogType_LOG_SYNC;
  static constexpr LogType LOG_ASYNC =
    SundialRequest_LogType_LOG_ASYNC;
  static constexpr LogType LOG_IF_NE =
    SundialRequest_LogType_LOG_IF_NE;
  static constexpr LogType LOG_IF_NE_DATA =
    SundialRequest_LogType_LOG_IF_NE_DATA;
  static constexpr LogType LOG_SYNC_DATA =
    SundialRequest_LogType_LOG_SYNC_DATA;
  static constexpr LogType LOG_ASYNC_DATA =
    SundialRequest_LogType_LOG_ASYNC_DATA;
  static inline bool LogType_IsValid(int value) {
    return SundialRequest_LogType_IsValid(value);
  }
  static constexpr LogType LogType_MIN =
    SundialRequest_LogType_LogType_MIN;
  static constexpr LogType LogType_MAX =
    SundialRequest_LogType_LogType_MAX;
  static constexpr int LogType_ARRAYSIZE =
    SundialRequest_LogType_LogType_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  LogType_descriptor() {
    return SundialRequest_LogType_descriptor();
  }
  template<typename T>
  static inline const std::string& LogType_Name(T enum_t_value) {
    ...
    return SundialRequest_LogType_Name(enum_t_value);
  }
  static inline bool LogType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      LogType* value) {
    return SundialRequest_LogType_Parse(name, value);
  }
  ...
  // .sundial_rpc.SundialRequest.LogType log_type = 6;
  void clear_log_type();
  ::sundial_rpc::SundialRequest_LogType log_type() const;
  void set_log_type(::sundial_rpc::SundialRequest_LogType value);
  private:
  ::sundial_rpc::SundialRequest_LogType _internal_log_type() const;
  void _internal_set_log_type(::sundial_rpc::SundialRequest_LogType value);
  public:
...
class SundialResponse final :
 ...
 public:
  ...
  static constexpr RequestType PAXOS_REPLICATE_ACK =
    SundialResponse_RequestType_PAXOS_REPLICATE_ACK;
  static constexpr RequestType NUM_REQ_TYPES =
...
// .sundial_rpc.SundialRequest.LogType log_type = 6;
inline void SundialRequest::clear_log_type() {
  log_type_ = 0;
}
inline ::sundial_rpc::SundialRequest_LogType SundialRequest::_internal_log_type() const {
  return static_cast< ::sundial_rpc::SundialRequest_LogType >(log_type_);
}
inline ::sundial_rpc::SundialRequest_LogType SundialRequest::log_type() const {
  // @@protoc_insertion_point(field_get:sundial_rpc.SundialRequest.log_type)
  return _internal_log_type();
}
inline void SundialRequest::_internal_set_log_type(::sundial_rpc::SundialRequest_LogType value) {
  
  log_type_ = value;
}
inline void SundialRequest::set_log_type(::sundial_rpc::SundialRequest_LogType value) {
  _internal_set_log_type(value);
  // @@protoc_insertion_point(field_set:sundial_rpc.SundialRequest.log_type)
}
...
template <> struct is_proto_enum< ::sundial_rpc::SundialRequest_LogType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::sundial_rpc::SundialRequest_LogType>() {
  return ::sundial_rpc::SundialRequest_LogType_descriptor();
}
